...
function SignIn() {
  ...
  function onSubmitSignUp(e) {
    ...
    if (confirmRef.current.value === passwordRefSignUp.current.value) {
      firebase.auth()
        .createUserWithEmailAndPassword(emailRefSignUp.current.value, passwordRefSignUp.current.value)
        .then(() => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => onSubmitSignUp(e)}>
        ...
        <div>
          Email:
          <input ref={emailRefSignUp} />
        </div>
        <div>
          Password:
          <input ref={passwordRefSignUp} />
        </div>
        <div>
          confirm Password:
      ...
      Send reset mail to this account:
      {' '}
      <input ref={emailRefReset} />
